...
// import logo from'./components/image/ani-gif.gif';
                        ...
                        <div className="row align-items-center mb--20">
                            <div className="col-lg-6 mb-20">
                                <div className="search-ticket-header">
                                    <h6 className="category">welcome to Evento</h6>
                            ...
                            <div className="tab-item active">
                                <form className="ticket-search-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select className="select-bar">
                                            <option value="26-6-22">23/10/2022</option>
                                            <option value="26-6-22">24/10/2022</option>
                                            <option value="26-6-22">25/10/2022</option>
                                            <option value="26-6-22">26/10/2022</option>
                                        </select>
                                    </div>
                                    <div className="form-group">
                                        <div className="thumb">
                    ...
                    <div className="row flex-wrap-reverse justify-content-center">
                        <div className="col-lg-3 col-sm-10  mt-50 mt-lg-0">
                            ...
                            <div className="widget-1 widget-banner">
                                <div className="widget-1-body">
                                    <a href="#0">
                                        <img src="assets/images/movie/gaming008.png" style={{ height: "300px" }} alt="banner" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-9">
                            <div className="article-section padding-bottom">
                                <div className="section-header-1">
                                    <h2 className="title">e-sports</h2>
                                ...
                                <div className="row mb-30-none justify-content-center">
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="movie-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src="assets/images/movie/gaming007.jpg" alt="movie" />
                                                </a>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="movie-grid">
                                            <div className="movie-thumb c-thumb" >
                                                <a href="#0">
                                                    <img src="assets/images/movie/gaming008.png" alt="movie" />
                                                </a>
                                            </div>
                                            <div className="movie-content bg-one">
                                                <h5 className="title m-0">
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="movie-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src="assets/images/movie/mincraft.webp" alt="movie" />
                                                </a>
                                            </div>
                                            <div className="movie-content bg-one">
                                                <h5 className="title m-0">
                                        ...
                                        <div className="event-grid">
                                            ...
                                            <div className="movie-content bg-one">
                                                ...
                                                <div className="movie-rating-percent">
                                                    <span> GNDU Computer Science department</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row mb-30-none justify-content-center">
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="sports-grid">
                                            ...
                                            <div className="movie-content bg-one">
                                                <h5 className="title m-0">
                                                    <a href="#0">world cricket league 2022</a>
                                                </h5>
                                                <div className="movie-rating-percent">
                                                    <span> GNDU</span>
                                                </div>
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="sports-grid">
                                            ...
                                            <div className="movie-content bg-one">
                                                <h5 className="title m-0">
                                                    <a href="#0">basket ball tournament 2022</a>
                                                </h5>
                                                <div className="movie-rating-percent">
