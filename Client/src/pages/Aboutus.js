                ...
                <div class="col-lg-6">
                    <div class="event-about-content">
                        <div class="section-header-3 left-style m-0">
                            ...
                            <p>
                            Welcome to Evento, your number one source for all things events. We're dedicated to giving you best services, with a focus on user interface , customer satisfaction.
                            </p>
                            <p>
                            Founded in 2022 by Saket Sourav, Evento has come a long way from its beginnings in Amritsar,Punjab. When Saket and Neel first started out, there passion for EVENTO drove them to do tons of research so that Evento can offer you best event management and booking website. We now serve customers all over city, and are thrilled that we're able to turn our passion into our own website.
                ...
                <div class="col-lg-8">
                    <div class="about-counter">
                        <div class="counter-item">
                            ...
                            <span class="d-block info">Students</span>
                        </div>
                        <div class="counter-item">
                            <div class="counter-thumb">
                            ...
                            <span class="d-block info">Colleges</span>
                        </div>
                        <div class="counter-item">
                            <div class="counter-thumb">
                            ...
                            <div class="counter-content">
                                <h3 class="title odometer" data-odometer-final="6"></h3>
                                <h3 class="title">+</h3>
                            </div>
